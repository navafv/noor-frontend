...
const AttendanceStatsPage = () => {
  ...
  if (loading && !stats) return <div className="p-8 text-center text-gray-400">Loading stats...</div>;
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-center">
        ...
        <select 
            className="bg-white border border-gray-200 text-sm rounded-lg p-2 outline-none"
            value={days}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-2 mb-2 text-green-600">
                <Users size={18} /> <span className="text-xs font-bold uppercase">Rate</span>
            </div>
      ...
      {/* Daily Breakdown (Last 7 Days usually) */}
      <div>

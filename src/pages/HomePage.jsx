    ...
    <div className="bg-white">
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white p-4">
          <h1 className="text-5xl md:text-7xl font-bold logo text-noor-pink">
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-5xl px-4 text-center">
          <h2 className="text-3xl font-bold text-noor-heading">Our Courses</h2>
      ...
      <section id="register" className="py-20 bg-white">
        <div className="mx-auto max-w-2xl px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-noor-heading">
          ...
          <div className="mt-10 p-8 bg-white rounded-xl shadow-2xl border border-gray-100">
            <EnquiryForm />
          </div>
        </div>
      </section>
...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="flex flex-col items-center">
    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-noor-pink/10 text-noor-pink">
      <Icon size={32} />
    </div>
    <h3 className="mt-4 text-xl font-semibold text-noor-heading">{title}</h3>
    <p className="mt-2 text-gray-600">{description}</p>
  </div>
);

const CourseCard = ({ title, description, imgSrc }) => (
  <div className="flex flex-col overflow-hidden rounded-xl shadow-lg text-left">
    <img src={imgSrc} alt={title} className="h-64 w-full object-cover" />
    <div className="p-6 bg-white flex-1">
      <h3 className="text-2xl font-semibold text-noor-heading">{title}</h3>
      <p className="mt-2 text-gray-600">{description}</p>
    </div>
  </div>
);
